...
**Last Updated:** Fri, 06 Feb 2026 19:36:32 GMT
...
If you need a simple list of items (not a hierarchical tree), consider using the [ListView](UIE-uxml-element-ListView.html) control.
...
**Note**: In the previouse example, the [TreeView.bindItem](../ScriptReference/UIElements.TreeView-bindItem.html) receives the Index. You must use the Index (not the ID) with [`GetItemDataForIndex<T>`](../ScriptReference/UIElements.BaseTreeView.GetItemDataForIndex.html).
...
Use [`BaseTreeViewController.GetIndexForId`](../ScriptReference/UIElements.BaseTreeViewController.GetIndexForId.html) and [`BaseTreeViewController.GetIdForIndex`](../ScriptReference/UIElements.BaseTreeViewController.GetIdForIndex.html).
...
**Base class**: [`BaseTreeView`](../ScriptReference/UIElements.BaseTreeView.html)
