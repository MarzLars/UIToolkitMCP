...
This page introduces the common USS properties, their syntax and accepted values, and differences from CSS. For a complete list of USS properties, refer to [USS properties reference](UIE-USS-Properties-Reference.html).
...
The `-unity-material` property assigns a custom material to the element. For more information, refer to [Get started with UI Shader Graph](ui-systems/get-started-with-ui-shader-graph.html).
...
* [USS filter](ui-systems/uss-filter.html)
