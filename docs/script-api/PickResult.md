...
For complete source code, see: [PickResult.cs](https://github.com/Unity-Technologies/UnityCsReference/blob/master/Modules/UIElements/Core/GameObjects/WorldSpaceInput.cs)
