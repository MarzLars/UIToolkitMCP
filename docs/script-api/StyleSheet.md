...
For complete source code, see: [StyleSheet.cs](https://github.com/Unity-Technologies/UnityCsReference/blob/master/Modules/UIElements/Core/StyleSheets/StyleSheet.cs)
