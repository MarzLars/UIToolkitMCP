...
For complete source code, see: [ManipulatorActivationFilter.cs](https://github.com/Unity-Technologies/UnityCsReference/blob/master/Modules/UIElements/Core/ManipulatorActivationFilter.cs)
